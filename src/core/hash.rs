...
pub fn header_for_config(style: CommentStyle, config: &crate::core::config::ResolvedCrateConfig) -> String {
    ...
    let body = match header_config {
        Some(header) => {
            ...
            let issues_url = header
                .issues_url
                .as_deref()
                .or_else(|| configured_header_url(config))
                .unwrap_or(DEFAULT_ISSUES_URL);
            format!(
                "This file is auto-generated by alef — DO NOT EDIT.\n\
...
Issues & docs: {issues_url}"
        ...
        None => {
            let issues_url = configured_header_url(config).unwrap_or(DEFAULT_ISSUES_URL);
            format!(
                "This file is auto-generated by alef — DO NOT EDIT.\n\
