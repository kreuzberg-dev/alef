...
Generated snapshots, docs, and guidance must also use neutral fixture names. Do not preserve downstream domain types such as product-specific config, result, visitor, handle, or backend names in expected output; rename them to generic fixture concepts before accepting snapshots.
