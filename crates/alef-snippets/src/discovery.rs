...
use crate::parser;
use crate::types::{Language, Snippet, SnippetAnnotation, SnippetAnnotationKind};
...
fn level_annotation(level: crate::types::ValidationLevel, reason: Option<String>) -> Option<SnippetAnnotation> {
    let kind = match level {
        crate::types::ValidationLevel::Syntax => SnippetAnnotationKind::SyntaxOnly,
        crate::types::ValidationLevel::Compile => SnippetAnnotationKind::CompileOnly,
        crate::types::ValidationLevel::Run => return None,
    };
    Some(SnippetAnnotation { kind, reason })
}
