...
impl Backend for CsharpBackend {
    ...
    fn generate_bindings(&self, api: &ApiSurface, config: &SkifConfig) -> anyhow::Result<Vec<GeneratedFile>> {
        ...
        let adapter_blocks = skif_adapters::generate_adapters(config, Language::Csharp)?;
        if !adapter_blocks.is_empty() {
            let adapters_class = format!("{}Adapters", wrapper_class_name);
            let mut adapter_content = String::new();
            adapter_content.push_str("// This file is auto-generated by skif. DO NOT EDIT.\n");
            adapter_content.push_str("using System;\nusing System.Runtime.InteropServices;\n\n");
            adapter_content.push_str(&format!("namespace {};\n\n", namespace));
            adapter_content.push_str(&format!("public static partial class {}\n{{\n", adapters_class));
            adapter_content.push_str(&format!(
                "    private const string LibName = \"{}\";\n\n",
                Self::lib_name(&prefix)
            ));
            for block in &adapter_blocks {
                adapter_content.push_str(block);
                adapter_content.push('\n');
            }
            adapter_content.push_str("}\n");
            files.push(GeneratedFile {
                path: base_path.join(format!("{}.cs", adapters_class)),
